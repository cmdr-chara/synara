...
p = "apps/server/src/provider/acp/DeepSeekAcpSupport.ts"
r(
    p,
...
r(
    ...
    '''      ...buildProviderChildEnvironment({
      ...
      SYNARA_DEEPSEEK_SESSIONS_ROOT:
        process.env.SYNARA_DEEPSEEK_SESSIONS_ROOT?.trim() || input.sessionsRoot,
      DSH_PERMISSION_MODE: deepSeekPermissionMode(input.runtimeMode),''',
)
r(
    p,
...
p = "apps/server/src/provider/Layers/DeepSeekAdapter.ts"
r(p, 'import {\n  ApprovalRequestId,', 'import * as nodePath from "node:path";\n\nimport {\n  ApprovalRequestId,')
r(
    p,
    '''import {
...
p = "apps/web/src/components/settings/ProvidersSettingsPanel.tsx"
r(
    p,
    '''  | "grokBinaryPath"
  | "droidBinaryPath"''',
...
'''
r(p, '  {\n    provider: "antigravity",', deepseek + '  {\n    provider: "antigravity",')

p = "apps/web/src/components/PluginLibrary.tsx"
r(
    p,
